export const uploadImage = async (base64, env = null) => {
  ...
  const filename = `img_${Date.now()}-${Math.random()
    .toString(36)
    .slice(2)}.png`;
  ...
  if (typeof process !== "undefined" && process.env) {
    try {
      ...
      const secretKey =
        "2738efcb1913d220a284d8635dade4f6a4f2d1ea6624de8df616b541dc04394b";
  ...
  throw new Error(
    "R2_BUCKET not available. Ensure R2 bucket is configured in wrangler.toml"
  );
};
